...
export default function Login() {
  return (
    <div className="min-h-screen bg-primary-light font-sans ">
      <Header />
      <div className="w-screen  h-screen pt-20 flex flex-col md:flex-row justify-between">
        <div className="w-full md:w-1/2 flex flex-col items-center justify-center relative z-10 mb-10 md:mb-0">
          ...
          <motion.h1
            ...
            className="
  text-6xl md:text-8xl font-bold mt-6 z-10 tracking-tight
  bg-[radial-gradient(circle_at_150%_50%,#FFFBE8_0%,#FFFBE8_10%,#091F5B_100%)]
